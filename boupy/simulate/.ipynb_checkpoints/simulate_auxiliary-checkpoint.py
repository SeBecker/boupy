...
def simulate_outcomes(data):
    ...
    for period in range(periods - 1):
        transitions[period + 1:,:] = transitions[period + 1:, :] - transitions[period, :]
...
def provide_renamedict(data, periods):
    """This function provides the rename dictionary based on the model specifications."""
...
def create_dataframe(data, periods):
    """This function processes the simulated data into a pandas datframe object."""
